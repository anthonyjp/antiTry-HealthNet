# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-04-10 17:19
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reason', models.SmallIntegerField(choices=[(0,
                                                              django_enumfield.enum.Value('EMERGENCY', 0, 'EMERGENCY',
                                                                                          registry.utility.options.AdmitOptions)),
                                                             (1, django_enumfield.enum.Value('SURGERY', 1, 'SURGERY',
                                                                                             registry.utility.options.AdmitOptions)),
                                                             (2,
                                                              django_enumfield.enum.Value('OBSERVANCE', 2, 'OBSERVANCE',
                                                                                          registry.utility.options.AdmitOptions))],
                                                    default=0)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hospital',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='admin_to',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                       related_name='patient_transfer_status', to='registry.TransferInfo'),
        ),
        migrations.AddField(
