# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-02-28 21:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[(0, django_enumfield.enum.Value('MALE', 0, 'M', registry.utility.options.Gender)), (1, django_enumfield.enum.Value('FEMALE', 1, 'F', registry.utility.options.Gender))], default='M', max_length=1)),
                ('security_question', models.CharField(choices=[(0, django_enumfield.enum.Value('Q1', 0, "What is your mother's maiden name?", registry.utility.options.SecurityQuestion))], default="What is your mother's maiden name?", max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blood_type', models.CharField(choices=[(0, django_enumfield.enum.Value('A', 0, 'A', registry.utility.options.BloodType)), (1, django_enumfield.enum.Value('B', 1, 'B', registry.utility.options.BloodType)), (2, django_enumfield.enum.Value('AB', 2, 'AB', registry.utility.options.BloodType)), (3, django_enumfield.enum.Value('O', 3, 'O', registry.utility.options.BloodType)), (4, django_enumfield.enum.Value('UNKNOWN', 4, '--', registry.utility.options.BloodType))], default='--', max_length=2)),
